...
public class CommentsInfoItem extends InfoItem {
    ...
    public void setCommentText(final String commentText) {
        this.commentText = new Description(commentText, Description.PLAIN_TEXT);
    }

    public void setCommentText(final Description commentText) {
        this.commentText = commentText == null ? Description.EMPTY_DESCRIPTION : commentText;
    }
    ...
    public List<Image> getUploaderAvatars() {
        ...
        return List.of(new Image(uploaderAvatarUrl, Image.HEIGHT_UNKNOWN, Image.WIDTH_UNKNOWN,
