...
class SponsorBlockFragment :
    ...
    override fun onCreateView(
        ...
        binding!!.sponsorBlockControlsMarkSegmentStart.setOnClickListener { v: View? ->
            doMarkPendingSegment(
                true
            )
        }
        binding!!.sponsorBlockControlsMarkSegmentEnd.setOnClickListener { v: View? ->
            doMarkPendingSegment(
                false
            )
        }
        binding!!.sponsorBlockControlsSegmentStart.setOnClickListener { v: View? ->
            doPendingSegmentSeek(
                true
            )
        }
        binding!!.sponsorBlockControlsSegmentEnd.setOnClickListener { v: View? ->
            doPendingSegmentSeek(
                false
            )
        }
        binding!!.sponsorBlockControlsClearSegment.setOnClickListener { v: View? -> doClearPendingSegment() }
        binding!!.sponsorBlockControlsSubmitSegment.setOnClickListener { v: View? -> doSubmitPendingSegment() }
    ...
    private fun doMarkPendingSegment(isStart: Boolean) {
        ...
        if (markedStartTime != null) {
            binding!!.sponsorBlockControlsSegmentStart.text = TimeUtils.millisecondsToString(markedStartTime!!.toDouble())
        }

        if (markedEndTime != null) {
            binding!!.sponsorBlockControlsSegmentEnd.text = TimeUtils.millisecondsToString(markedEndTime!!.toDouble())
        }
