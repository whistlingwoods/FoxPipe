...
class ReturnYouTubeDislikeSettingsFragment : BasePreferenceFragment() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (rydWebsitePreference != null) {
            rydWebsitePreference.onPreferenceClickListener = { p: Preference ->
                val i = Intent(
                    Intent.ACTION_VIEW,
        ...
        if (rydSecurityFaqPreference != null) {
            rydSecurityFaqPreference.onPreferenceClickListener = { p: Preference ->
                val i = Intent(
                    Intent.ACTION_VIEW,
