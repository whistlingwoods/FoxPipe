    ...
    fun convertCategoryToColor(
        ...
        when (category) {
            SponsorBlockCategory.SPONSOR -> {
                ...
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.sponsor_segment)
            }

            SponsorBlockCategory.INTRO -> {
                key = context.getString(R.string.sponsor_block_category_intro_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.intro_segment)
            }

            SponsorBlockCategory.OUTRO -> {
                key = context.getString(R.string.sponsor_block_category_outro_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.outro_segment)
            }

            SponsorBlockCategory.INTERACTION -> {
                key = context.getString(R.string.sponsor_block_category_interaction_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.interaction_segment)
            }

            SponsorBlockCategory.HIGHLIGHT -> {
                key = context.getString(R.string.sponsor_block_category_highlight_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.highlight_segment)
            }

            SponsorBlockCategory.SELF_PROMO -> {
                key = context.getString(R.string.sponsor_block_category_self_promo_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.self_promo_segment)
            }

            SponsorBlockCategory.NON_MUSIC -> {
                key = context.getString(R.string.sponsor_block_category_non_music_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.non_music_segment)
            }

            SponsorBlockCategory.PREVIEW -> {
                key = context.getString(R.string.sponsor_block_category_preview_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.preview_segment)
            }

            SponsorBlockCategory.FILLER -> {
                key = context.getString(R.string.sponsor_block_category_filler_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.filler_segment)
            }

            SponsorBlockCategory.PENDING -> {
                key = context.getString(R.string.sponsor_block_category_pending_color_key)
                colorStr = prefs.getString(key, null)
                return colorStr?.toColorInt() ?: androidx.core.content.ContextCompat.getColor(context, R.color.pending_segment)
            }
